...
🌟 อย่างไรก็ตาม ตลอดหลายสิบปีที่ผ่านมา หลายประเทศทั่วโลกต่างรณรงค์และลงทุนกับพลังงานหมุนเวียนอย่างจริงจังไม่น้อย คำถามคือ... ทำไมภาพรวมถึงยังดูเหมือนเราย่ำอยู่กับที่? เป็นไปได้หรือไม่ว่าการเปรียบเทียบแค่จุดเริ่มต้น (ปี 2000) กับจุดปลาย (ปี 2024) กำลังกลบสัญญาณการเปลี่ยนแปลงสำคัญที่ซ่อนอยู่ "ระหว่างทาง"
...
💡 ภาพรวมระดับโลกอาจสรุปได้ว่าเรายังอยู่ในยุค **Addition** แต่โลกนี้ไม่ได้เติบโตด้วยความเร็วที่เท่ากัน เพื่อค้นหาว่าทวีปใดที่ **'เปลี่ยนผ่าน (Transition)'** ไปแล้ว และทวีปใดที่ยังคงใช้ฟอสซิลขับเคลื่อนการเติบโตเป็นหลัก เราจึงต้องเจาะลึกข้อมูลแบบรายทวีปในมิติต่อไป
...
---
<a id="slow-build"></a>
## สองกลุ่มต่างกันตรงไหน (What Separates the Two Groups in Proportion?)
