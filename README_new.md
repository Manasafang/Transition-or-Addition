...
| | คำถาม | ตอบในส่วน |
|---|---|---|
| **คำถามหลัก** | ระหว่างปี 2000–2024 พลังงานหมุนเวียนกำลังเปลี่ยนผ่านเชื้อเพลิงฟอสซิล (Transition) หรือเพียงเพิ่มเติมเข้าระบบเพื่อรองรับความต้องการที่โตขึ้น (Addition)? | 4–10 |
| **RQ1** | ในระดับโลกและระดับประเทศ ภาพนี้เป็นแบบไหน และแนวโน้มช่วงหลังเปลี่ยนไปหรือไม่? | 4–7 |
| **RQ2** | ความต้องการไฟฟ้าที่โตมากสัมพันธ์กับการเป็น Addition หรือไม่? | 8 |
