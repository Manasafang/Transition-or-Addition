...
🌟 หลังจากจำแนกประเทศตามรูปแบบ Transition และ Addition แล้ว จึงเกิดคำถามต่อว่า ประเทศที่อยู่ในแต่ละรูปแบบมีลักษณะการเติบโตของพลังงานหมุนเวียนและการเปลี่ยนแปลงของระบบไฟฟ้าแตกต่างกันอย่างไร

ภาพที่ 8 เริ่มจากการเปรียบเทียบการเพิ่มขึ้นของพลังงานหมุนเวียนในหน่วย TWh ซึ่งแสดงให้เห็นว่าประเทศในทั้งสองกลุ่มสามารถมีการเติบโตของพลังงานหมุนเวียนในระดับสูงได้ อย่างไรก็ตาม การเปรียบเทียบด้วย TWh เพียงอย่างเดียวขึ้นอยู่กับขนาดของระบบไฟฟ้าของแต่ละประเทศ จึงนำการเติบโตของพลังงานหมุนเวียนมาเทียบเป็น สัดส่วนต่อขนาดระบบไฟฟ้าของแต่ละประเทศ (% ของไฟฟ้าที่ผลิตในปี 2000)

| ประเทศ | กลุ่ม | Δ RE (TWh) | Δ RE (% ของปี 2000) | ความต้องการที่โต (% ของปี 2000) |
|---|---|---|---|---|
