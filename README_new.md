...
**ข้อควรระวัง:** กราฟเรียงตามปริมาณ TWh จึงเป็นประเทศที่ระบบไฟฟ้าใหญ่เป็นส่วนใหญ่ ไม่ได้บอกว่าประเทศเล็กกว่าเป็นอย่างไร 

<details>
<summary>Table 5 (ตารางเดิม ครบทุกประเทศ)</summary>
...
- ภาพที่ 8: เปรียบเทียบผลต่างการผลิตไฟฟ้าจากพลังงานหมุนเวียนและเชื้อเพลิงฟอสซิลในแต่ละประเทศ พร้อมจำแนกรูปแบบตามเกณฑ์ Transition / Addition ที่กำหนดไว้ในตารางที่ 1
...
---
<a id="s8"></a>
## ความต้องการไฟฟ้าที่โตกับการเป็น Addition
...
**ทำไมเลือกเฉพาะประเทศที่ผลิตไฟฟ้าเกิน 5 TWh ในปี 2000:** ตัววัดของ RQ2 หารด้วยไฟฟ้าที่ผลิตปี 2000 ประเทศที่ฐานเล็กมากจึงได้เปอร์เซ็นต์สูงเกินจริง (เช่น เอธิโอเปียจาก 1.7 เป็น 25.2 TWh คือ +1,391%) และการจัดกลุ่มก็เปราะบาง เพราะฟอสซิลตั้งต้นเล็กจิ๋ว (เอธิโอเปีย 0.02 TWh) แค่หายไปก็นับเป็น Transition ทั้งที่ความต้องการพุ่ง จึงตัดประเทศที่ฐานไม่เกิน 5 TWh ออก เหลือ 104 ประเทศ เกณฑ์นี้เป็นค่าที่เลือกเอง และสรุปไม่เปลี่ยนเมื่อเปลี่ยนเกณฑ์

<details>
<summary>ตารางผลเมื่อเปลี่ยนเกณฑ์ขั้นต่ำ</summary>

**Table 8: เปรียบเทียบ Transition (T) กับ Addition (A) เมื่อเปลี่ยนเกณฑ์ขั้นต่ำของไฟฟ้าที่ผลิตปี 2000**

| เกณฑ์ (ผลิตปี 2000 เกิน) | ประเทศทั้งหมด | T / A | ความต้องการโต (มัธยฐาน T / A) | แยกกลุ่มได้ (ช่วงเชื่อมั่น 95%) | หมุนเวียนที่เพิ่ม (มัธยฐาน T / A) | แยกกลุ่มได้ (ช่วงเชื่อมั่น 95%) |
|---|---|---|---|---|---|---|
...
*"แยกกลุ่มได้" คือความน่าจะเป็นที่ประเทศ Addition ที่สุ่มมามีค่าสูงกว่าประเทศ Transition (0.50 = ไม่ต่างกัน ดูคำอธิบายใน 8.2) ช่วงเชื่อมั่น 95% คำนวณด้วย bootstrap (สุ่มประเทศซ้ำ 2,000 รอบ) "ประเทศทั้งหมด" รวมกลุ่มอื่น (Fossil Expansion, Decline) ที่ไม่นำมาเทียบ*

**อ่านผล:** ความต้องการแยกสองกลุ่มได้ทุกเกณฑ์ (0.88–0.95) โดยขอบล่างของช่วงเชื่อมั่นไม่ต่ำกว่า 0.79 ส่วนหมุนเวียนที่เพิ่มไม่ต่างกันทุกเกณฑ์ (0.41–0.50) เพราะช่วงเชื่อมั่นคร่อม 0.50 ทุกแถว ค่าของความต้องการเพิ่มจาก 0.88 เป็น 0.95 เมื่อตัดประเทศฐานเล็ก เพราะประเทศ Transition ฐานเล็กบางประเทศมีความต้องการโตมาก แต่ผลต่างนี้เล็ก
