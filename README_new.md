...
| | คำถาม | ตอบในส่วน |
|---|---|---|
| **RQ1** | ในระดับโลกและระดับประเทศ ภาพนี้เป็นแบบไหน และแนวโน้มช่วงหลังเปลี่ยนไปหรือไม่? | [ภาพรวมทั่วโลก](#global-overview) ถึง [ระดับประเทศ](#country-level) |
| **RQ2** | เมื่อเทียบเป็นสัดส่วนของขนาดระบบไฟฟ้า ประเทศ Addition ต่างจากประเทศ Transition ตรงที่เพิ่มพลังงานหมุนเวียนน้อยกว่า หรือตรงที่ความต้องการไฟฟ้าโตมากกว่า? | [สองกลุ่มต่างกันตรงไหน](#slow-build) |
