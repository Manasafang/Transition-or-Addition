...
---
**Figure 9: หมุนเวียนที่เพิ่มเทียบกับความต้องการที่โต (Renewable Growth vs Demand Growth, 104 Countries)**

![Figure 9](images/figure9.png)

- ภาพที่ 9: ความต้องการไฟฟ้าที่โต (แกน X) เทียบกับหมุนเวียนที่เพิ่ม (แกน Y) ของ 104 ประเทศ ปี 2000 → 2024 ทั้งสองแกนเป็น % ของไฟฟ้าที่ผลิตปี 2000 และใช้สเกลเดียวกัน (symlog: ยืดค่าน้อย ย่อค่ามาก เพื่อแสดงประเทศที่ความต้องการลดลงได้) เส้นประคือหมุนเวียนที่เพิ่มเท่ากับไฟฟ้าใหม่พอดี (เส้นแบ่ง Transition โดยประมาณ) วงกลมเขียว = Transition สามเหลี่ยมเหลือง = Addition สี่เหลี่ยมเทา = กลุ่มอื่น จุดใหญ่คือ 6 ประเทศตัวอย่าง สามเหลี่ยมบนแกนคือมัธยฐานของแต่ละกลุ่ม (ผลลัพธ์ชี้ว่าความต้องการต่างกันมากระหว่างสองกลุ่ม แต่หมุนเวียนที่เพิ่มซ้อนทับกัน)

**ข้อสรุปสำคัญ (Key Takeaways):**

- **หมุนเวียนที่เพิ่มใกล้เคียงกัน:** มัธยฐาน +31% ในกลุ่ม Transition และ +26% ในกลุ่ม Addition จีนสร้างหมุนเวียนเพิ่ม +234% ของฐานปี 2000 แต่ก็ยังเป็น Addition
- **ความต้องการที่โตต่างกันมาก:** มัธยฐาน +5.5% ในกลุ่ม Transition และ +144% ในกลุ่ม Addition จีนโตถึง +644%

💡 ผลลัพธ์นี้แสดงว่า **ประเทศ Addition ไม่ได้เพิ่มพลังงานหมุนเวียนน้อยกว่าประเทศ Transition** สิ่งที่ต่างกันคือความต้องการไฟฟ้าที่โตมากกว่ามาก การเพิ่มหมุนเวียนให้เร็วอย่างเดียวจึงไม่พอ ต้องเพิ่มให้เกินไฟฟ้าใหม่
