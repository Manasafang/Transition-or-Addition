...
🌟 แต่เดี๋ยวก่อน — ตลอดหลายสิบปีที่ผ่านมา หลายประเทศทั่วโลกต่างรณรงค์และลงทุนกับพลังงานหมุนเวียนกันอย่างจริงจังไม่น้อย แล้วทำไมภาพรวมถึงยังออกมาเป็น Addition อยู่ดี เป็นไปได้ไหมว่าการดูแค่จุดเริ่มต้น (ปี 2000) เทียบกับจุดปลาย (ปี 2024) สองจุดนี้ กำลังกลบสัญญาณการเปลี่ยนแปลงบางอย่างที่เกิดขึ้น "ระหว่างทาง" ไว้ เราจึงต้องพิจารณา "แนวโน้ม" ของการเติบโตในแต่ละช่วงเวลาดูอีกที เพื่อดูว่าการขยายตัวของพลังงานหมุนเวียนและเชื้อเพลิงฟอสซิลเปลี่ยนแปลงไปอย่างไรในแต่ละช่วงเวลา
...
จากกราฟแสดงให้เห็นว่าสัญญาณของการ "เปลี่ยนผ่าน" ที่เรากำลังมองหา มันมีอยู่จริง ไม่ใช่เพียงความคาดหวัง แต่คำถามคือ แล้วมันไปเกิดขึ้นที่ไหน ทำไมตอนมองภาพรวมทั้งโลกกลับไม่เห็นสัญญาณนี้ชัดขนาดนี้ เป็นไปได้ไหมว่าการมองภาพรวมโลกกำลังกลบสัญญาณที่เกิดขึ้นจริงในบางจุดไว้?
...
**สรุปสั้นๆ:** Energy Transition กำลังเกิดขึ้นจริง แต่ไม่พร้อมกันทุกประเทศ และการเติบโตของพลังงานหมุนเวียนเพียงอย่างเดียวไม่เพียงพอที่จะบอกว่าเชื้อเพลิงฟอสซิลกำลังถูกเปลี่ยนผ่าน
